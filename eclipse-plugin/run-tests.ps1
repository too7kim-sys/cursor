...
$pure = @("JsonUtil","Json","MarkdownScanner","CodeEdit","Mentions","FileProposals","SessionStore","SymbolIndex","Problems","ChangeParser","GhostText","EditMatch","VerifyReport","EditHistory") |
