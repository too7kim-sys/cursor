...
$pure = @("JsonUtil","Json","MarkdownScanner","CodeEdit","Mentions","FileProposals","SessionStore","SymbolIndex","Problems","ChangeParser","GhostText","EditMatch","GlobMatcher","TextSearch","ContextManager","PlanRenderer","VerifyReport","EditHistory","FileChange","AgentEditController","OllamaClient","TextDiff","OllamaAgent") |
